...
from utils.gesture_recognition import recognize_gesture  # Import the gesture recognition function
    ...
    try:
        ...
        if result.multi_hand_landmarks:
            for hand_landmarks in result.multi_hand_landmarks:
                ...
                gesture = recognize_gesture(hand_landmarks.landmark)  # Call gesture recognition function
